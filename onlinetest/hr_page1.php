...
<tr><td><table bgcolor="#99ff33" width="100%"><tr valign="top"><td>
    ...
    <nav class="menu">
        <ul class="clearfix">
            ...
            <li style="padding-left:70px;">
                <a href="#">HR <span class="arrow">&#9660;</span></a>
                 <ul class="sub-menu">
                    <li><a href="job_availibility.php">Job Code Management</a></li>
                    <li><a href="candidate_lists.php">Candidate Management</a></li>
                    <li><a href="job_code_paper_list.php">Job Code Paper</a></li>
                    <li><a href="candidate_job_info_list.php">Candidate Job Info</a></li>
                </ul>
            </li>
            <li style="padding-left:70px;">
                <a href="#">Team Lead <span class="arrow">&#9660;</span></a>
                 <ul class="sub-menu">
                    <li><a href="office_user_login.php">Team Lead Login</a></li>
     ...
     <button type="submit" name="logout" style="float:right;"><a href="hr_logout.php">Log Out </a></button>
     <pre style="text-align:left; font-family:verdana;color:#00e600;font-size:250%;text-shadow: 2px 2px 2px green;"><b>
    HUMAN RESOURCES ISN'T A THING WE DO</b></pre>
    <pre style="text-align:left; font-family:verdana;color:blue;font-size:250%; padding-left:80px;text-shadow: 2px 2px 2px blue;"><b>
